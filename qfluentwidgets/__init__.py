"""Clean minimal shim for qfluentwidgets used for local development/tests.

This file implements a very small subset of the real package so the app
and tests can run without installing qfluentwidgets. It's intended for
...
class FluentIcon:
    ...
    """(Replaced) Minimal local shim for qfluentwidgets used by this project.

    This file is a single, clean implementation to avoid previous duplication/corruption.
    It intentionally keeps behaviour simple and robust for tests and local runs.
    """
